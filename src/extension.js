...
const { detectFieldCommand } = require("./detect-field-command");
...
const activate = (context) => {
  ...
  context.subscriptions.push(vscode.commands.registerCommand("extension.detectField", async () => await detectFieldCommand(context)));
